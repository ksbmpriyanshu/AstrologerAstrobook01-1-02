...
import CallDetails from '../screens/history/CallDetails';
import LiveDetails from '../screens/history/LiveDetails';
...
const StackNavigator = (data, data1) => {
  ...
  return (
    ...
    <Stack.Navigator initialRouteName={data_route}>
      ...
      <Stack.Screen
        name="ascednt"
        component={AscedentReport}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="rashiReport"
        component={RashiReport}
        options={{headerShown: false}}
      />
      <Stack.Screen
      ...
      <Stack.Group
        ...
        <Stack.Screen name="videocalldetails" component={VideoCallDetails} />
        ...
        <Stack.Screen
          name="bookedPoojaDetails"
          component={BookedPoojaDetails}
        />
      ...
      <Stack.Screen
        name="livenow"
        component={LiveNow}
        options={{animation: 'fade', headerShown: true, gestureEnabled: false}}
      />
      <Stack.Screen
        options={{headerShown: false}}
        name="HostPage"
      ...
      <Stack.Screen
        name="Assignedpuja"
        component={Assignedpuja}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="Assignedpujanext"
        component={Assignedpujanext}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="Gifthistrotyorder"
        component={Gifthistrotyorder}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="Completepuja"
        component={Completepuja}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="Notifications"
      ...
      />
      <Stack.Screen
        name="Completepujanext"
        component={Completepujanext}
        options={{headerShown: false}}
      />

      <Stack.Screen
        name="RegisterdbookPooja"
        component={RegisterdbookPooja}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="Pujasubmit"
        component={Pujasubmit}
        options={{headerShown: false}}
      />
      <Stack.Screen
        name="my-earnings"
