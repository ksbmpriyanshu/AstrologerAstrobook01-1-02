  ...
  return (
    <ImageBackground
      ...
      <GiftedChat
        ...
        alwaysShowSend
        textInputProps={{
          style: {...Fonts.black14InterMedium, flex: 1},
        ...
        renderActions={() => (
          <View
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() =>
                dispatch(SettingActions.setImagePickerVisible(true))
              }>
              <Ionicons
                name="image"
        ...
        renderChatFooter={() =>
          chatImageData && (
            <View
              ...
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() => dispatch(ChatActions.setChatImageData(false))}
          ...
          return (
            <Bubble
              ...
              textStyle={{
                ...
                left: {color: colors.background_theme2, fontSize: 12},
              }}
            />
          );
        }}
