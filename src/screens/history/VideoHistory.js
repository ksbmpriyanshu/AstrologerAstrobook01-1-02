      ...
      <View style={{paddingHorizontal:SCREEN_WIDTH*0.02,}}>
        <View style={{flexDirection:'row',marginVertical:SCREEN_HEIGHT*0.006,justifyContent:"space-between",paddingVertical:SCREEN_HEIGHT*0.02,paddingHorizontal:SCREEN_WIDTH*0.015,borderRadius:10,backgroundColor:"white",elevation:1}}> 
            ...
            <View style={{gap:2}}>
              ...
              <Text style={{...Fonts.black11InterMedium,color:colors.black_color6,fontSize:responsiveFontSize(1.5)}}>Commision Price: {showNumber(item?.adminPrice)}/min</Text>
              <Text style={{...Fonts.black11InterMedium ,color:colors.black_color6,fontSize:responsiveFontSize(1.5)}}>Astro Price: {showNumber(item?.partnerPrice)}</Text>
              <Text style={{...Fonts.black11InterMedium ,color:colors.black_color6,fontSize:responsiveFontSize(1.5)}}>Status: Completed</Text>
            </View>
